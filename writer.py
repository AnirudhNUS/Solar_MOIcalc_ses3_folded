...
def make_graphs():
    ...
    # only moix for 12U is higher than moiz. otherwise always moiz is highest 
    ...
    plt.title('Power per unit mass for folded panels', fontsize = 16) 
    # plt.legend() 
    plt.yticks(PM) 
    ...
    plt.title('Power per unit volume for folded panels', fontsize = 16) 
    # plt.legend() 
    plt.yticks(PV) 
    ...
    plt.title('MOI for folded panels', fontsize = 16) 
    # plt.legend() 
    plt.yticks(moiz) 
